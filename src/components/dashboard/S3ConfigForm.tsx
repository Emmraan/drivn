...
import CorsConfigurator from "@/components/dashboard/CorsConfigurator";
import {
  CloudIcon,
  CheckCircleIcon,
...
export default function S3ConfigForm({
  ...
  useEffect(() => {
    const provider = commonProviders.find(
  ...
  return (
    <Card className="p-6">
      <div className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            Endpoint URL (started from https://)
          </label>
          <input
            type="text"
        ...
        <div className="flex items-center">
          <input
            ...
            onChange={(e) =>
              handleInputChange("forcePathStyle", e.target.checked)
            }
        ...
        {/* CORS Configuration */}
        <CorsConfigurator appUrl={process.env.NEXT_PUBLIC_APP_URL || ""} />
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm text-blue-700 dark:text-blue-300">
              ...
              <p>
                ...
                only used for file operations and are never transmitted in plain
                text.
              </p>
            </div>
          </div>
